...
export default function Button({
  ...
  const variants = {
    primary: 'bg-[#0A58CA] text-white hover:bg-[#084298] focus:ring-[#0A58CA] shadow-xs',
    secondary: 'bg-slate-900 text-white hover:bg-slate-800 focus:ring-slate-900 shadow-xs',
    outline: 'border border-slate-300 bg-white text-slate-700 hover:bg-slate-50 focus:ring-[#0A58CA]',
  ...
  const sizes = {
    ...
    lg: 'text-base px-6 py-3.5 rounded-xl gap-2.5 min-h-[50px]',
  };
