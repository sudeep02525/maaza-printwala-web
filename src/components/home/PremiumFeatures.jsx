      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 relative z-10">
          {[
            ...
            <motion.div key={idx} whileHover={{ y: -8, scale: 1.02 }} className="group bg-white p-8 rounded-[24px] border border-slate-100 shadow-[0_4px_20px_rgba(0,0,0,0.03)] hover:shadow-[0_12px_40px_rgba(0,130,202,0.1)] transition-all duration-300 relative overflow-hidden text-left">
              ...
              <div className="relative z-10">
                <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-blue-50 to-blue-100 flex items-center justify-center mb-6 shadow-sm border border-blue-200/50 group-hover:scale-110 transition-transform duration-300">
